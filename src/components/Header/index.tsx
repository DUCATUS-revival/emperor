    ...
    <header className='header'>
      <div className='row'>
        <div className='header__content'>
          ...
          <div className='header__btn hidden-d' onClick={() => setNavbarOpen(!isNavbarOpen)}>
            {isNavbarOpen ? <img src={NavCloseImg} alt='' /> : <img src={NavOpenImg} alt='' />}
          </div>
          <div className='header__navbar hidden-m'>
            <NavHashLink exact smooth to='/#top' className='text-md header__link'>
              Home
            </NavHashLink>
            <NavHashLink to='/#business' smooth={true} className='text-md header__link'>
              Our Business
            </NavHashLink>
      ...
      >
        <div className='header__menu-nav'>
          <NavHashLink exact smooth to='/#top' className=' h1 header__menu-link' onClick={() => setNavbarOpen(false)}>
            Home
          </NavHashLink>
          <NavHashLink onClick={() => setNavbarOpen(false)} to='/#business' smooth className=' h1 header__menu-link'>
            Our Business
          </NavHashLink>
          <NavHashLink
